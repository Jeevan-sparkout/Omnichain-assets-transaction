...
This project is indexed by GitNexus as **Omnichain-assets-transaction** (997 symbols, 1119 relationships, 6 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
